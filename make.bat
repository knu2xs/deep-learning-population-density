...
SETLOCAL
SET PROJECT_DIR=%cd%
SET PROJECT_NAME=deep-learning-population-density
SET SUPPORT_LIBRARY = deep_learning_population_density
SET ENV_NAME=pop-density
...
:build_upload
    ENDLOCAL & (
        ...
        :: Build conda package
        CALL conda build ./conda-recipe --output-folder ./conda-recipe/conda-build
        CALL anaconda upload ./conda-recipe/conda-build/win-64/deep-learning-population-density*.tar.bz2
